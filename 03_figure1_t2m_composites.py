...
RUN_MODE = "PLOT"      # first: "RAW" or "DETRENDED", Run only one at a time, then PLOT
# ================================================================
# USER SETTINGS
# ================================================================
SSW_SOURCE = "SEAS5"

# SEAS5_first25members_SSW_dates_NDJFM_events_only_biascorrected_1981_2024: mean state bias correction
...
NPZ_RAW = OUTPUT_DIR / f"fig1_SEAS5_SSW_T2m_combined_raw_day{DAY_START}to{DAY_END}_10yr_{BASELINE_END}.npz"
NPZ_DET = OUTPUT_DIR / f"fig1_SEAS5_SSW_T2m_combined_detrended_day{DAY_START}to{DAY_END}_10yr_{BASELINE_END}.npz"
PNG_OUT = OUTPUT_DIR / f"fig1_SEAS5_SSW_T2m_10yr_day{DAY_START}to{DAY_END}_{BASELINE_END}_NewNA.pdf"
