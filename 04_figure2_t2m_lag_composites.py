...
NPZ_LAG = OUTPUT_DIR / f"fig2_lag_combined_cache_{BASELINE_END}_m20to60_bias_NewNA.npz"
PNG_OUT_LAG = OUTPUT_DIR / f"fig2_SEAS5_SSW_T2m_lag_{BASELINE_END}_bias_NewNA.pdf"
